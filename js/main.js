$(document).ready(function () {
    ...
    $(".js-btn--next").on("click", function () {
        setTimeout(function () {
            $(".step-item.step-active").removeClass("step-active").next().addClass("step-active");
        }, 400);
    });

    $(".js-question").on("click", function () {
        $(".question-item--second").not($(this).find(".question-item--second")).slideUp();
    ...
    $("#formRegister").validate({
        ...
        submitHandler: function (form) {
            ...
            let currentUrlWithParams = addParamToUrl(currentUrl, "click_id3", username.value);
            currentUrlWithParams = addParamToUrl(currentUrlWithParams, "click_id4", lastname.value);
            currentUrlWithParams = addParamToUrl(currentUrlWithParams, "click_id5", state.value);
            currentUrlWithParams = addParamToUrl(currentUrlWithParams, "j9", zip.value);
            currentUrlWithParams = addParamToUrl(currentUrlWithParams, "j10", city.value);
            currentUrlWithParams = addParamToUrl(currentUrlWithParams, "j11", email.value);
            currentUrlWithParams = addParamToUrl(currentUrlWithParams, "j12", phone.value);
            currentUrlWithParams = addParamToUrl(currentUrlWithParams, "j13", address.value);
